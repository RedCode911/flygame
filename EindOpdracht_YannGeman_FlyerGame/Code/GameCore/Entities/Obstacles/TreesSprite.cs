...
{
    internal class TreesSprite : EnemySprite
    {
        private readonly IMovementStrategy _movementStrategy;

        public TreesSprite(Texture2D texture, Vector2 position, float speed,
        ...
        public override Rectangle CollisionBox
        {
            get
            {
                Rectangle box = new Rectangle((int)Math.Round(Position.X), (int)Math.Round(Position.Y), 16, 16);
                return box;
            }
        }

...
{
    internal class RedHouseFactory
    {
        public static RedHouseSprite CreateBig(Texture2D texture, float x, float y, float speed, float baseScale)
        {
            return Create(texture, new Vector2(x, y), speed, baseScale * 1.5F);
        }

        public static RedHouseSprite CreateSmall(Texture2D texture, float x, float y, float speed, float baseScale)
        {
            return Create(texture, new Vector2(x, y), speed, baseScale * 0.75F);
        }

        public static RedHouseSprite Create(Texture2D texture, float x, float y, float speed, float scale)
        {
            return Create(texture, new Vector2(x, y), speed, scale);
        }

        public static RedHouseSprite Create(Texture2D texture, Vector2 position, float speed, float scale)
        {
            ...
            return new RedHouseSprite(texture, position, speed, movementStrategy, scale);
        }
    }
}
